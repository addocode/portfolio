...
<html lang="de">
  <head>
    ...
    <title>Adam Dolinsky | Profil</title>
    <meta name="description" content="Professionelles Profil von Adam Dolinsky: Digital Marketing, Web, Content und Medienproduktion für Unternehmen in der Schweiz." />
  ...
  <body>
    ...
    <main>
        ...
        <div class="container profile-split">
          <div>
            ...
            <div class="timeline">
              ...
              <article class="timeline__item">
                <div class="timeline__date">08/2017 – 08/2021</div>
                <h3>Mediamatiker in Ausbildung, Digitale Medien der Armee &amp; BiCT AG</h3>
                <p>Medienprojekte in Web, Print und Video; Vertiefung in CMS, Adobe Creative Cloud, HTML/CSS, Projektmanagement und CI/CD-konformer Gestaltung.</p>
              </article>
              <article class="timeline__item">
                <div class="timeline__date">2019 / 2020</div>
                <h3>Livestream-Operator &amp; Eventassistenz</h3>
                <p>Technische Betreuung von Streaming-Infrastruktur, YouTube-Livestreams sowie Unterstützung bei Organisation, Logistik und Social Media.</p>
              </article>
            </div>
          </div>
      ...
      <section class="cta" aria-label="Kontakt">
